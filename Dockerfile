...
RUN git clone --branch 'cleaned4pia-vendor-update' --depth 1 https://github.com/FluxState/stoppropaganda.git . && \
...
ARG SP_USERAGENT="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36"
